...
class  coq_round 
{
	...
	{ 
		...
		$this->round_score1 = $score1;
		$this->round_score2 = $score2;
		$this->end1 = $end1;
		$this->end2 = $end2;
	} 
	...
	{	
		return $this->round_score1; 
	}

	public function get_score2()
	{	
		return $this->round_score2; 
	}
	...
	{
		$this->round_score1 = $value;
	}

	public function set_score2($value)
	{
		$this->round_score2 = $value;
	}
	...
	public function update($id)
	{
		...
		'UPDATE coq_round SET
			...
			round_score1 = "'.$this->round_score1.'",
			round_score2 = "'.$this->round_score2.'",
			end1 = "'.$this->end1.'",
			end2 = "'.$this->end2.'"
		WHERE id ='.$id;
		$this->pdo = initPDOObject();
	...
	public function JSON ()
	{
		return json_encode(array("id" => $this->id, "chosen_theme1_id" => $this->chosen_theme1_id, 
								...
								"selected_theme_id" => $this->selected_theme_id, "round_score1" => $this->round_score1,
								"round_score2" => $this->round_score2, "end1" => $this->end1, "end2" => $this->end2));
	}
}
?>
